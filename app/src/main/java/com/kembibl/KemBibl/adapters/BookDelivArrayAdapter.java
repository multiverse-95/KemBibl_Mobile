...
public class BookDelivArrayAdapter extends ArrayAdapter<BookModel> {
    private Context context;
    private List<BookModel> bookModels;

    // Конструктор, вызывается при создании
    public BookDelivArrayAdapter(Context context, int resource, ArrayList<BookModel> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // получаем контекст со страницы полученных книг
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Activity.LAYOUT_INFLATER_SERVICE);
        View view = inflater.inflate(R.layout.book_deliv_layout, null);
        ...
        TextView code_book=(TextView) view.findViewById(R.id.code_book);
        ...
        TextView filial=(TextView) view.findViewById(R.id.filial);
        ...
        code_book.setText("Штрих-код: "+String.valueOf(bookModel.getCode_book()));
        date_start.setText("Дата выдачи: "+String.valueOf(bookModel.getDate_start()));
        date_finish.setText("Сдать до: "+String.valueOf(bookModel.getDate_finish()));
        filial.setText("Филиал: "+String.valueOf(bookModel.getFilial()));
