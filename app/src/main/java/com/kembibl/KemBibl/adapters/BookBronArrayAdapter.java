...
public class BookBronArrayAdapter extends ArrayAdapter<BookModel> {
    private Context context;
    private List<BookModel> bookModels;

    // Конструктор, вызывается при создании
    public BookBronArrayAdapter(Context context, int resource, ArrayList<BookModel> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // получаем контекст со страницы забронированнных книг
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Activity.LAYOUT_INFLATER_SERVICE);
        View view = inflater.inflate(R.layout.book_bron_layout, null);
        ...
        date_finish.setText("Бронь кончается: "+String.valueOf(bookModel.getDate_finish()));
