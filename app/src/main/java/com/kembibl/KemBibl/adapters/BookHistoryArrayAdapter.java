...
public class BookHistoryArrayAdapter extends ArrayAdapter<BookModel> {
    private Context context;
    private List<BookModel> bookModels;

    // Конструктор, вызывается при создании
    public BookHistoryArrayAdapter(Context context, int resource, ArrayList<BookModel> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // получаем контекст со страницы истории бронирований книг
